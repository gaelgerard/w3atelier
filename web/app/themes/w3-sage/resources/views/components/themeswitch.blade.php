<button id="theme-toggle" type="button" class="group cursor-pointer text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-sm p-2.5 transition-all active:scale-95">
...
<script>
  (function() {
    ...
    // Mise à jour des icônes basée sur l'état réel du HTML
