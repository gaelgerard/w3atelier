@if (has_nav_menu('primary_navigation'))
  <nav class="nav-primary" x-data="{ open: false }">
    ...
    <div 
      id="mobile-menu" 
      class="fixed inset-0 z-40 bg-white dark:bg-gray-900 md:dark:bg-transparent transform translate-x-full transition-transform duration-300 ease-in-out md:relative md:inset-auto md:translate-x-0 md:flex md:items-center"
    >
