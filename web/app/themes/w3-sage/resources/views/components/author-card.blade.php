...
<div class="space-y-4">
    <div class="space-y-2">
        ...
        <div class="space-y-1 font-mono text-xs uppercase tracking-wider text-gray-600 dark:text-gray-400">
            <p class="font-semibold text-primary-700 dark:text-primary-400">Consultant web senior</p>
    ...
    <div class="flex gap-4">
        {{-- Lien Mail --}}
        <a class="group text-gray-700 dark:text-gray-200 transition-colors" href="/accompagnement" title="Me contacter">
